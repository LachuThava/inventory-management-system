    ...
    <div>
        ...
        <div className='flex -mt-5'>
              {!student && <div className='text-lg flex font-bold w-screen  items-center justify-evenly mt-10 bg-slate-500 h-16 '>
                  <span className='w-16 col-2 text-center'>No.</span>
                  <span className='w-16 col-2 text-center'>Date/Time</span>
                  <span className='w-16 col-2 text-center'>Asset_id</span>
                  <span className='w-16 col-2 text-center'>Student</span>
                  <span className='w-16 col-3 text-center'>Submitted Time</span>
              </div>}
                ...
                return (
                    <div key={key} className='shadow-lg justify-between mb-1  border-l-8  border-l-green-600 p-1 text-lg flex'>
                        {!student &&<div className='items-center justify-evenly flex m-auto w-8/12 h-16'>
                              <span className='w-36 col-2 text-center '>{key}</span>
                            <span className='w-36 col-4 text-center  '>{item.assigned_time}</span>
                            <span className='w-36 col-3 text-center  '>{item.asset_id}</span>
                            <span className='w-36 col-3 text-center  '>{item.student}</span>
                            <span className='w-36 col-4 text-center  '>{item.submitted_time}</span>
                        </div>}
                        {student &&<div className='items-center justify-evenly flex m-auto w-8/12 h-16'>
